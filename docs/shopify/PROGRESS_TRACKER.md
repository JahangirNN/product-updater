...
| :--- | :---: | :---: | :---: | :---: | :--- |
| **Jomashop (Pilot)** | 574 | 🟢 Ingestion Active | 46 / 574 | 2026-09-24 | Pilot: 46 Versace Luxury Watches Live |
...
| **TOTAL** | **3,189** | - | **46 / 3,189** | - | **Target: 100% Ingested** |
...
| :--- | :---: | :--- | :--- | :--- | :---: |
| **Luxury Watches** | Smart | `product_type EQUALS Watches` | `luxury-watches` | `gid://shopify/Collection/693133148326` | ✅ Live (46 prods) |
| **Versace** | Smart | `vendor EQUALS Versace` | `versace` | `gid://shopify/Collection/693133213862` | ✅ Live (46 prods) |
| **Tissot** | Smart | `vendor EQUALS Tissot` | `tissot` | `gid://shopify/Collection/693133246630` | ✅ Live |
...
| **2026-09-24** | Smart Collection Auto-Population Verification | `46 items in Versace, 46 in Luxury Watches` | `verify_shopify_pilot.py` |
