...
def run_full_inflow(max_workers: int = 3, min_size_variants: int = 1):
    print("=" * 75)
    print("NORDSTROM HOKA SHOES CATALOG INGESTION (X-MODE TIER 1)")
    ...
    urls_file = "scratch/all_hoka_urls.json"
    ...
    total = len(urls)
    print(f"Loaded {total} unique Nordstrom Hoka shoe URLs for ingestion.")
